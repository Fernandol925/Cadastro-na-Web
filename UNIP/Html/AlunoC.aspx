<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AlunoC.aspx.cs" Inherits="UNIP.AlunoC" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <section id="formulario">
            ...
            <asp:TextBox ID="txtRa" runat="server" placeholder="Ra" CssClass="campo" min="7" pattern="[A-Za-z0-9]{7}" ToolTip="Ra com 7 digitos"></asp:TextBox>
            ...
            <asp:TextBox ID="txtSenha" runat="server" placeholder="Senha" TextMode="Password" pattern="[A-Za-z0-9]{8}" ViewStateMode="Enabled"></asp:TextBox>
            ...
            <asp:Label ID="ltMensagem1" runat="server" BackColor="#66FFFF" BorderColor="Red" Font-Bold="True" Font-Names="Arial Black" Font-Size="16px" Height="50px" BorderStyle="None"></asp:Label>
        </section>
    </form>
</body>
</html>
