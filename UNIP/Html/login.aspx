<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="UNIP.Html.login" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <section id="formulario">
            ...
            <asp:Button ID="Button2" runat="server" Text="Cadastrar" PostBackUrl="~/Html/AlunoC.aspx" CssClass="btn" />
